...
public class SubmitOrderPage2 extends BaseTest{
	...
	public void submitOrder(HashMap<String,String> hashmap) throws IOException {
		...
		ProductCatalogue pc = landingPage.loginToApplication(hashmap.get("email"),hashmap.get("password"));
		List<WebElement> elements = pc.getProducts();
		pc.addProductToCart(hashmap.get("productName"));
		CartPage cp = pc.goToCartPage(); //calling method of parent class using object of child class
		Boolean match=cp.verifyItemPresent(hashmap.get("productName"));
	...
	//sending data as HashMaps
	@DataProvider
	public Object[][] getData(){
		HashMap<String,String> map1 = new HashMap<String,String>();
		map1.put("email","harilol@hotmail.com");
		map1.put("password","Hari555.hd!");
		map1.put("productName","ADIDAS ORIGINAL");
		
		HashMap<String,String> map2 = new HashMap<String,String>();
		map2.put("email","liukang@hotmail.com");
		map2.put("password","Liukang@69");
